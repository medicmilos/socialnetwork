    ...
    <nav id="visina" class="navbar navbar-inverse navbar-static-top" role="navigation">
        <div id="visina"  class="container-fluid">
            <div class="col-xs-12 col-sm-7 col-sm-offset-3 alldropdown">	
                ...
                <form class="col-xs-12 navbar-form navbar-left">
                    <span class="input-group stylish-input-group">
                        <input type="text" onmousedown="event.cancelBubble = true;" ontouchstart="event.cancelBubble = true;" class="text ts_input" autocomplete="off" name="" placeholder="Search">
                    </span>  
                </form> 
                <?php if ($this->session->userdata('ulogovan')): ?>
                    <span class="dropdown"> 
                        ...
                        <a href="#" data-toggle="dropdown" class="dropdown-toggle "><img src="<?php echo base_url(); ?>images/notifications.png" alt=""/></a> 
                    </span>	
